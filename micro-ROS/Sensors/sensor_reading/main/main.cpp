...
void micro_ros_task(void *arg) {
    ...
    RCCHECK(rclc_publisher_init_default(&publisher_imu, &node_imu, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Float32MultiArray), "/position/IMU"));
    // create imu timer
    ...
    */   
    ...
    RCCHECK(rclc_publisher_init_default(&publisher_gps, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Float32MultiArray), "/position/GPS"));
    // create gps timer
    ...
    RCCHECK(rclc_publisher_init_default(&publisher_wind, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Float32MultiArray), "/direction/wind"));
    // create wind timer
