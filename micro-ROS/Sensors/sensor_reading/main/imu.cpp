...
void imu_callback(void* arg) {
    ...
    while (1) {
        ...
        if ((mpuIntStatus & 0x10) || fifoCount == 1024) mpu.resetFIFO();  // reset so we can continue cleanly
        ...
        // otherwise, check for DMP data ready interrupt frequently)
            ...
            // Convert to float so that it fits Float32MultiArray
        ...
        // Best result is to match frequency with DMP refresh rate
