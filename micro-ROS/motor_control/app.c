...
void appMain(void *argument)
{
	...
	RCCHECK(rclc_subscription_init_default(
		&sub_sail, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Float32), "/position/SAIL_ANGLE"));
	RCCHECK(rclc_subscription_init_default(
		&sub_rudder, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Float32), "/rudder/ANGLE"));
	...
	mcpwm_gpio_init(MCPWM_UNIT_1, MCPWM1A, SERVO_PULSE_GPIO_RUDDER); // To drive a RC servo, one MCPWM generator is enough
