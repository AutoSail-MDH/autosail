...
: ${AMENT_CURRENT_PREFIX:="/home/skola/Projects/int32_publisher_custom_transport/components/micro_ros_espidf_component-galactic/micro_ros_dev/install/ament_cmake_gtest"}
