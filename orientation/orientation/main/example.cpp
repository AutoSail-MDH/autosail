...
<<<<<<< HEAD:main/example.cpp
#include <sensor_msgs/msg/joy.h>
=======
#include <std_msgs/msg/float32_multi_array.h>
>>>>>>> 60dd9c24b13b11c8184d465f3665b957a8d9ba7c:orientation/main/example.cpp
#include <rclc/rclc.h>
...
int32_t accel[2];			// [accX accY accZ]		The accelerometer values in XYZ
int32_t gyro[2];			// [gyrX gyrY gyrZ]		The gyroscope values in XYZ
...
<<<<<<< HEAD:main/example.cpp
			...
			msg.buttons.data = &accel[i];
			msg.buttons.size++;
		}

		for(int32_t i = 0; i < 3; i++){
			msg.buttons.data = &gyro[i];
			msg.buttons.size++;
		}

		gettimeofday(&tv,NULL);
		msg.header.stamp.nanosec = tv.tv_usec;
...
>>>>>>> 60dd9c24b13b11c8184d465f3665b957a8d9ba7c:orientation/main/example.cpp
	...
	*/
<<<<<<< HEAD:main/example.cpp
	static float_t yprArr[2];
	msg.axes.capacity = 2;
	msg.axes.data = yprArr;
	msg.axes.size = 0;

	static int32_t imuArr[5];
	msg.buttons.capacity = 5;
	msg.buttons.data = imuArr;
	msg.buttons.size = 0;
=======
